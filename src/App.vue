  ...
  <div ref="main" class="main" tabindex="1">
    <div class="game-container">
      <div class="game-header">
        <div class="game-header-title">2048 game</div>
      ...
      <div class="game-footer">
        <div class="game-footer-head1">排行榜</div>
        <div class="game-footer-head2">分数前一百名<span @click="handleFlesh">刷新</span></div>
        <top-list-vue ref="topList"></top-list-vue>
      </div>
    </div>
  </div>
</template>
...
import topListVue from './components/topList.vue'
